...
Si se crea o modifica un layout de página (`app/**/layout.tsx`), verificar que todas las URLs (canonical, openGraph.url, alternates) usan el dominio `https://www.llumandglow.com` y no dominios de Vercel ni de desarrollo.
